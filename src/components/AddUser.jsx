...
const Contenido = ({ mostrarMensaje }) => {
  ...
  const getColaboradores = () => {
    // axios.get("http://wsdx.berlinasdelfonce.com:9000/api/users/").then((response) => {
    axios
  ...
  const getUsers = () => {
    // axios.get("http://wsdx.berlinasdelfonce.com:9000/api/login/").then((response) => {
    axios
  ...
  const capturarImagen = async () => {
    ...
    try {
      const response = await axios.post(
        // "http://wsdx.berlinasdelfonce.com:9000/subir_ft/",
        "http://wsdx.berlinasdelfonce.com:9000/subir_ft/",
        formData
      );
